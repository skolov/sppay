...
!function (a, b) {
  ...
  b.fn.pagination && (g = "pagination2"), b.fn[g] = function (f) {
    ...
    var j = b(this),
      ...
      generatePageNumbersHTML: function generatePageNumbersHTML(a) {
        var b,
            c = this,
            d = a.currentPage,
            e = c.getTotalPage(),
        ...
        if (null === k.pageRange) {
          for (b = 1; b <= e; b++) {
            h += b == d ? '<li class="' + l + "-page J-paginationjs-page " + m + '" data-num="' + b + '"><a>' + b + "</a></li>" : '<li class="' + l + '-page J-paginationjs-page" data-num="' + b + '"><a href="' + i + '">' + b + "</a></li>";
          }

          return h;
        }

        if (f <= 3) for (b = 1; b < f; b++) {
          h += b == d ? '<li class="' + l + "-page J-paginationjs-page " + m + '" data-num="' + b + '"><a>' + b + "</a></li>" : '<li class="' + l + '-page J-paginationjs-page" data-num="' + b + '"><a href="' + i + '">' + b + "</a></li>";
        ...
        if (g >= e - 2) for (b = g + 1; b <= e; b++) {
          h += '<li class="' + l + '-page J-paginationjs-page" data-num="' + b + '"><a href="' + i + '">' + b + "</a></li>";
